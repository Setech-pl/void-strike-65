> **ARCHIVED — pre-hybrid, 2026-09-15.** Superseded by
> [../hardware-testing.md](../hardware-testing.md). It assumes the pre-Raider
> "Interceptor" as the ordinary enemy, pickups earned from those kills, the
> retired 2x2/2x3 character pickup capsule, and staging hashes that were
> current only for its own checkpoint. Kept as evidence; not an active source
> of truth.
